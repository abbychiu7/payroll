...
import static com.ict.payroll.domain.EmployeeAsserts.*;
...
import com.ict.payroll.domain.Employee;
import com.ict.payroll.repository.EmployeeRepository;
...
class EmployeeResourceIT {
    ...
    void putExistingEmployee() throws Exception {
        ...
        updatedEmployee.name(UPDATED_NAME).position(UPDATED_POSITION).department(UPDATED_DEPARTMENT).monthlySalary(UPDATED_MONTHLY_SALARY);
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.name(UPDATED_NAME).position(UPDATED_POSITION).department(UPDATED_DEPARTMENT);
