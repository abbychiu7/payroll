...
/**
 * REST controller for managing {@link com.ict.payroll.domain.Payment}.
 */
@RestController
...
public class PaymentResource {
    ...
    public ResponseEntity<Payment> partialUpdatePayment(
        ...
        Optional<Payment> result = paymentRepository
            ...
            .map(existingPayment -> {
                if (payment.getPayMonth() != null) {
                    existingPayment.setPayMonth(payment.getPayMonth());
                }
                if (payment.getPayYear() != null) {
                    existingPayment.setPayYear(payment.getPayYear());
                }
                if (payment.getMonthlySalary() != null) {
                    existingPayment.setMonthlySalary(payment.getMonthlySalary());
                }
                if (payment.getDeductions() != null) {
                    existingPayment.setDeductions(payment.getDeductions());
                }
                if (payment.getNetPay() != null) {
                    existingPayment.setNetPay(payment.getNetPay());
                }
